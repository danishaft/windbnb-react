                ...
                <form action="">
                    <div className="modal__form">
                        <div onClick={() => activate("item1")} className="input__data">
                            <input id="location" type="text" name="location" value={formData.location} readOnly />
                            <label htmlFor="">LOCATION</label>
                        </div>
                        <div onClick={() => activate("item2")} className="input__data">
                            <input id="guests" type="text" name="guests" value={sum > 0 ? ` ${sum} guests` : "Add guests"} readOnly/>
                            <label htmlFor="">GUESTS</label>
                        </div>
                        <div className="input__data tablet">
                    ...
                    <button id="mobile" type="submit" onClick={handleSubmit}><BsSearch className="submit__icon" />Search</button>
                </form>
            </div>
        </div>
       </>
